...
import com.example.Hong_park_springBoot.service.ArticleService;
...
public class ArticleApiController {
    ...
    public ResponseEntity<Article> create(@RequestBody ArticleForm dto) {//@RequestBody: json형식을 dto로 받아오는 어노테이션
    ...
    public ResponseEntity<List<Article>> trasactionTest
